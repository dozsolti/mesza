...
export default function UbiSmile({
  className,
  ...props
}: {
  ...
  return (
    <svg
      ...
      viewBox="0 5.551115123125783e-17 256 256"
      width="256"
      height="256"
      {...props}
    ...
    >
      ...
      <path
        fillRule="evenodd"
        className="e"
        d="m129.5 203c-3.6 0-6.5-2.5-6.5-5.5 0-3 3.2-2 6.8-2 3.6 0 6.2-1 6.2 2 0 3-2.9 5.5-6.5 5.5z"
      />
    </svg>
  );
}
